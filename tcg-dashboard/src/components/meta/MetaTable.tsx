...
function WinRateBadge({ rate, encounters }: { rate: number | null; encounters: number }) {
  ...
  if (encounters < 5) {
    return <span className="text-gray-500 font-semibold">{rate}% <span className="text-gray-600 font-normal">(n={encounters})</span></span>;
  }
                ...
                >
                  ...
                  <td className="px-4 py-2.5 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <span className="text-gray-300 text-xs w-8 text-right">{s.frequencyPct}%</span>
                    </div>
                  </td>
