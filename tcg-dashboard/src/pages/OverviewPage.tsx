...
export function OverviewPage() {
  const { activeDeckId, activeDeck, deckCards, opponentLogs, metaSnapshots, archetypeStats } = useDashboardStore();
  ...
  const topMeta = metaSnapshots.length > 0
    ...
    <div className="space-y-6">
      <div>
        ...
        {activeDeck ? (
          ...
          <p className="text-sm text-gray-500 mt-0.5">Kein aktives Deck — wähle eines unter "My Decks"</p>
        )}
      </div>
