  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm">Track opponent decks from League Challenges and Cups</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        />
        <StatCard label="LC / LCup" value={`${lcGames} / ${lcupGames}`} sub="by event type" color="blue" />
        <StatCard label="Archetypes Faced" value={uniqueArchetypes} sub="distinct deck types" color="purple" />
      </div>
